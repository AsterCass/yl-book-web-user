...
**Company:** BOH TECHNOLOGY CONSULTING & TRADING INC
**Mailing Address:** 204 Hillturn Lane, Roslyn Heights, NY 11577
**Email:** legal@zyyboh.com
**Website:** https://booking.zyyboh.com/

If you have questions, requests, or complaints regarding this Privacy Policy or our handling of your information, please contact us at the email address above. We aim to respond to all inquiries within thirty (30) days.
...
### 3.2 Information We Do Not Collect Through the Site

We want to be clear about what the Site does **not** collect:

- **We do not collect payment information through the Site.** All bookings are made without payment. Payment for services is made in person at our physical location at the time of service. We do not process, transmit, or store credit card numbers, bank account details, or other payment instruments through the Site.
- **We do not collect government identification numbers**, dates of birth, or physical mailing addresses.
- **We do not collect health, medical, or treatment information through the Site.** The booking process asks only for the account and scheduling details described in Section 3.1. It does not ask about your health conditions, symptoms, medications, injuries, or medical history, and there is no free-text field intended for such information.

> ### Important: health information and the scope of this Policy
>
> Some of our Services — including acupuncture and massage therapy — are provided by practitioners licensed under New York State law. In the course of providing those Services at our physical location, we may collect health-related information from you, such as intake questionnaires, consultation notes, contraindication screening, and treatment records.
>
> **This Privacy Policy does not govern that information.** Health information collected at our location is maintained separately from the Site's systems, is subject to professional confidentiality obligations and to federal and New York State law governing patient records, and is handled under a separate notice provided to you at our location. Please ask our staff for that notice, or contact us if you did not receive one.
>
> **Please do not send health information through the Site or by email.** Neither the booking form nor ordinary email is a secure or appropriate channel for medical information. If you need to discuss a health condition, allergy, injury, pregnancy, or medication before your appointment, please raise it with your practitioner in person at the start of your session, or telephone us. If you do send health information through the Site or by email despite this request, we will handle it with appropriate confidentiality, but we cannot guarantee the security of information transmitted this way.

### 3.3 Information Collected Automatically

**Cookies and similar technologies.** We use cookies, browser local storage (`localStorage`), and similar technologies that store small amounts of data on your device. These are collectively referred to in this Policy as "storage technologies." At present the Site relies primarily on local storage rather than cookies, but we may use either or both, and this Policy covers both.

We use storage technologies only for the following purposes:
...
**Your control.** Data stored on your device remains on your device. You can clear or block it at any time:

- **Local storage:** through your browser's settings, typically under "Clear browsing data," "Site data," "Cookies and site data," or "Storage"
- **Cookies:** through your browser's cookie settings, which generally allow you to block all cookies, block third-party cookies, or delete existing cookies

Clearing this data will sign you out and reset your preferences, but will not delete your account or your existing bookings. Blocking strictly necessary storage will prevent you from signing in or making a booking.

**Server logs.** Like most websites, our web servers automatically record technical information when you access the Site, including your IP address, browser type and version, operating system, referring page, and the date and time of your request. We use these logs for security monitoring, fraud prevention, diagnosing technical problems, and understanding aggregate usage patterns.

### 3.4 Do Not Track

Some browsers offer a "Do Not Track" (DNT) signal. Because there is no consistent industry standard for how DNT signals should be interpreted, the Site does not currently respond to them. As noted above, we do not engage in cross-site tracking of our users in any event.
...
**Verification code.** A mobile telephone number is required to complete a booking, because the store needs a way to reach you about your appointment. To confirm the number belongs to you, the booking form has a "Send code" button; **only when you tap it** do we send a single one-time passcode to that number. That message is triggered by your own action, is not a subscription, and stops there.

**Appointment text messages — separate, optional consent.** Appointment texts (confirmations, reminders, reschedule and cancellation notices) are sent **only if you check the dedicated box** on the booking form. That box is unchecked by default. **You can complete a booking without checking it** — providing your phone number does not by itself subscribe you to anything, and declining has no effect on your booking. If you do not check it, we send your booking confirmation and any changes by email instead.

**Marketing text messages — separate, optional consent.** Separately, and only if you check a **second, independent** opt-in checkbox on the booking form, we may send you occasional promotional offers and coupons by text message. This checkbox is unchecked by default and entirely optional, and is never bundled with the appointment-texts box: you may choose either, both, or neither. **Consent to receive marketing text messages is optional and is not a condition of booking or purchasing any goods or services from us.** You can complete a booking without checking it, and if you do not check it you will receive verification and booking-related messages only. We record each consent — and each withdrawal — with a timestamp, the source IP address, and the version of the exact wording displayed to you at the time. Promotional messages may contain links, which will only ever point to our own website (booking.zyyboh.com).
...
**Legal compliance.** We may disclose information when we believe in good faith that disclosure is required by law, regulation, subpoena, court order, or other valid legal process, or is necessary to respond to a lawful request from a government or law enforcement authority.

**Protection of rights and safety.** We may disclose information where we believe it is reasonably necessary to investigate or prevent fraud, enforce our Terms of Service, protect the rights, property, or safety of BOH, our clients, our staff, or the public, or to address an emergency involving danger of death or serious physical injury.

**Business transfers.** If BOH is involved in a merger, acquisition, reorganization, sale of assets, financing, or bankruptcy, your information may be transferred as part of that transaction. We will provide notice on the Site before your information becomes subject to a materially different privacy policy.

**With your direction.** We will share information in other ways if you ask us to or otherwise direct us to do so.
...
We retain your information for as long as your account remains active and for so long thereafter as is necessary for the purposes described in this Policy.
...
| Records of your acceptance of these policies | Duration of the account, plus 6 years, for evidentiary purposes |

We may retain information longer where required by law, or where necessary to resolve a dispute, enforce our agreements, or comply with a legal hold. When information is no longer needed, we delete it or de-identify it so that it can no longer reasonably be associated with you.
...
If you are a California resident, the California Consumer Privacy Act, as amended by the California Privacy Rights Act ("CCPA"), may afford you additional rights. We extend the following rights to California residents:
...
To submit a CCPA request, email **legal@zyyboh.com** with the subject line "California Privacy Request." We will confirm receipt within ten (10) business days and respond substantively within forty-five (45) days, with one extension of up to forty-five additional days where reasonably necessary. There is no charge for these requests unless they are manifestly unfounded or excessive.

### 9.3 Additional Rights for Residents of Other U.S. States

Residents of certain other states — including Colorado, Connecticut, Virginia, Utah, Texas, Oregon, and Montana — have comprehensive privacy laws granting rights similar to those described above. If you are a resident of one of those states, you may exercise those rights by contacting us at legal@zyyboh.com. We honor these requests regardless of your state of residence.

Some of these states provide a right to appeal a refusal to act on a privacy request. If we decline your request, we will explain why, and you may appeal by replying to our decision. If your appeal is denied, you may contact your state attorney general.

### 9.4 Users Outside the United States

The Site is intended for use by individuals located in the United States. Our services are provided at a physical location in the United States, and all information is stored and processed in the United States. If you access the Site from outside the United States, you do so on your own initiative and are responsible for compliance with local law. By using the Site, you consent to the transfer of your information to, and its processing in, the United States, which may have data protection laws different from those of your jurisdiction.

---

## 10. Children's Privacy

The Site is not directed to children, and we do not knowingly collect personal information from anyone under the age of thirteen (13). If you are under 13, please do not create an account or submit any information through the Site.

If we learn that we have collected personal information from a child under 13, we will delete that information promptly. If you are a parent or guardian and believe your child has provided us with personal information, please contact us at legal@zyyboh.com and we will take appropriate action.

Users between the ages of 13 and 18 should review this Policy with a parent or guardian, and should obtain parental consent before booking a service. Certain services may have age restrictions imposed by law or by our own policies; please contact us with any questions.

---

## 11. Third-Party Links

The Site may contain links to third-party websites, including map services, business directories, or social media pages. This Privacy Policy does not apply to those sites. We do not control and are not responsible for the privacy practices or content of any third party. We encourage you to review the privacy policy of any site you visit through a link from ours.
...
If we make material changes — for example, if we begin collecting a new category of information or begin sharing information with a new category of recipient — we will provide more prominent notice, such as a notice on the Site homepage or an email to the address associated with your account, at least thirty (30) days before the change takes effect where practicable.

Your continued use of the Site after a change becomes effective constitutes acceptance of the revised Policy. If you do not agree to the revised Policy, you should stop using the Site and may request deletion of your account.

---

## 13. Contact Us

For any question, request, or complaint regarding this Privacy Policy:
